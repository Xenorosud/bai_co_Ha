...
export function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: "/admin/food-management", label: "Food Management", icon: <UtensilsCrossed className="w-5 h-5" /> },
    { path: "/admin/order-management", label: "Order Management", icon: <ShoppingBag className="w-5 h-5" /> },
    { path: "/admin/table-management", label: "Table Management", icon: <Grid3x3 className="w-5 h-5" /> },
    { path: "/admin/reservation-management", label: "Reservation Management", icon: <Calendar className="w-5 h-5" /> },
    { path: "/admin/workers-management", label: "Workers Management", icon: <Users className="w-5 h-5" /> },
    { path: "/admin/payment-management", label: "Payment Management", icon: <CreditCard className="w-5 h-5" /> },
    { path: "/admin/inventory-management", label: "Inventory Management", icon: <Package className="w-5 h-5" /> },
  ];
