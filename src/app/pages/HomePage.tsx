    ...
    <div>
      ...
      <section className="relative h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-4">Welcome to Restora</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">Discover our most loved dishes</p>
          </div>
      ...
      <section className="py-16 bg-amber-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">Reserve your table today and enjoy an unforgettable experience</p>
          <Link
            to="/reservation"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">123 Restaurant Street<br />New York, NY 10001</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Mon-Fri: 11:00 AM - 10:00 PM<br />Sat-Sun: 10:00 AM - 11:00 PM</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">(555) 123-4567<br />info@restora.com</p>
              </div>
            </div>
          </div>
        </div>
