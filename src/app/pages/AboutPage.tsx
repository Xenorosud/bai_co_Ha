  ...
  const values = [
    {
      ...
      description: "We source only the finest, freshest ingredients from local suppliers and farms.",
    },
    {
      icon: <Heart className="w-8 h-8" />,
      title: "Passion for Food",
      description: "Every dish is prepared with love and attention to detail by our dedicated team.",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Community Focus",
      description: "We believe in giving back to our community and supporting local businesses.",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Excellence",
      description: "Our commitment to excellence has earned us numerous awards and recognition.",
    },
  ];
  ...
  const team = [
    {
      ...
      role: "Head Chef",
      image: "https://images.unsplash.com/photo-1717838207789-62684e75a770?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwY2hlZiUyMGNvb2tpbmd8ZW58MXx8fHwxNzc0NzcyOTQ4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-amber-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-amber-100">Our Story, Our Passion, Our Commitment</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Founded in 2010, Restora began with a simple vision: to create a dining experience
                  that celebrates fresh, locally-sourced ingredients and exceptional hospitality.
                  What started as a small family-owned restaurant has grown into a beloved culinary
                  destination in the heart of New York City.
                </p>
                <p>
                  Our journey has been guided by a commitment to quality, innovation, and community.
                  We believe that great food brings people together, creating memories that last a
                  lifetime. Every dish we serve tells a story, combining traditional techniques with
                  modern creativity.
                </p>
                <p>
                  Today, Restora continues to evolve while staying true to our core values. We're
                  proud to be part of the local community and grateful for the loyal guests who have
                  made us a part of their lives.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">Best Restaurant 2025</h3>
      ...
      <section className="py-16 bg-amber-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">Experience the Restora Difference</h2>
