  ...
  const menuItems: MenuItem[] = [
    {
      ...
      description:
        "Prime cut ribeye with herb butter, mashed potatoes, and seasonal vegetables",
      price: 42,
      category: "food",
      type: "Main Course",
      image:
    ...
    },
    {
      ...
      description:
        "House-made pasta with pancetta, egg yolk, and aged parmesan",
      price: 28,
      category: "food",
      type: "Main Course",
      image:
    ...
    },
    {
      ...
      description:
        "A selection of artisanal cheeses, cured meats, and accompaniments",
      price: 32,
      category: "food",
      type: "Appetizer",
      image:
        "https://images.unsplash.com/photo-1755811248324-3c9b7c8865fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnb3VybWV0JTIwZm9vZCUyMHBsYXRpbmd8ZW58MXx8fHwxNzc0NzY0ODA5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      isOnSale: true,
      salePrice: 26,
    },
    {
    ...
    },
    {
      ...
      description:
        "Our house special blend with premium spirits and fresh ingredients",
      price: 16,
      category: "drink",
      type: "Cocktail",
      image:
        "https://images.unsplash.com/photo-1650691960684-c15e3e2d5c85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2NrdGFpbCUyMGRyaW5rcyUyMGJhcnxlbnwxfHx8fDE3NzQ4Mzc2MDN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      isOnSale: true,
      salePrice: 12,
    },
    {
